package com.shivangsapplication.app.modules.filter.`data`.model
...
public data class FilterModel(
   ...
   * TODO Replace with dynamic value
   */
  public var txtPrice: String? = MyApp.getInstance().resources.getString(R.string.lbl_1_245)
  ,
  /**
   * TODO Replace with dynamic value
   */
  public var txtPrice1: String? = MyApp.getInstance().resources.getString(R.string.lbl_9_344)
  ,
  /**
   * TODO Replace with dynamic value
   */
