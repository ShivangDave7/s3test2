package com.shivangsapplication.app.modules.productdetail.`data`.model
...
public data class ProductDetailModel(
   ...
   * TODO Replace with dynamic value
   */
  public var txtStyle: String? = MyApp.getInstance().resources.getString(R.string.lbl_style)
  ,
  /**
   * TODO Replace with dynamic value
   */
  public var txtStylecode: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_cd0113_400)
  ,
  /**
   * TODO Replace with dynamic value
   */
   ...
   * TODO Replace with dynamic value
   */
  public var txtReviewcount: String? =
      MyApp.getInstance().resources.getString(R.string.lbl_5_review)
  ,
  /**
   * TODO Replace with dynamic value
   */
